...
class Friend_Component_Ajax_Ajax extends Phpfox_Ajax
{
	...
	public function processRequest()
	{
		...
		//add Maxim Tyulenev!!!add Friend in view chat and send message friend.
		$this->call('$Core.Chat.updateFriend();');
		Chat_Service_Chat::instance() -> addFriend($this->get('user_id'));
		//end
	...
	public function delete()
	{
		...
		//add Maxim Tyulenev!!!add Friend in view chat and send message friend.
		Chat_Service_Chat::instance() -> removeFriend($this->get('friend_user_id'));
		//end
		if ($bDeleted)
		{
			if ($this->get('reload'))
